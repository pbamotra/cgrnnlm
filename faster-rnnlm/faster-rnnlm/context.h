...
public:
    Context(const ContextConfig &cfg); 
		...
		void ComputeContextMatrixAll(Vocabulary vocab, const WordIndex *sen, const int seq_length);
		void ComputeContextMatrixWithPrev(Vocabulary vocab, const WordIndex *sen, const int seq_length, int prev);
		void ComputeContextMatrix(Vocabulary vocab, const WordIndex *sen, const int seq_length);
		void ComputeContextMatrix(Vocabulary vocab, const WordIndex *sen, RowMatrix * temp_context_matrix);
